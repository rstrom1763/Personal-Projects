Function Move-Pictures {
    ...
    if (!(Test-Path "$FilePath/jpg") -and (Test-Path "*.jpg")) { New-Item -ItemType Directory jpg }
    ...
    Get-ChildItem | Where-Object { $_.name -like "*.jpg" -or $_.name -like "*.jpeg" } | Move-Item -Destination ./jpg
